...
const router = new Router({
  routes: [
    ...
    },
    {
      ...
      meta: {
        name: '风暴潮',
        icon: 'iconfont icon-taifeng'
      },
      children: [
        {
          path: '/surges',
          name: 'surges',
          component: () => import('@/views/typhoon/1.surges/index'),
          meta: {
            name: '风暴潮'
          }
        }
      ...
      children: [
        {
          path: '/rain',
          name: 'rain',
          component: () => import('@/views/typhoon/2.rain/index'),
          meta: {
            name: '降水预测'
          }
        }
      ...
      children: [
        {
          path: '/wind',
          name: 'wind',
          component: () => import('@/views/typhoon/3.wind/index'),
          meta: {
            name: '风场预测'
          }
        }
    ...
    },
    {
      ...
      meta: {
        name: '海流预测',
        icon: 'iconfont icon-lang'
      },
      children: [
        {
          path: '/seawater',
          name: 'seawater',
          component: () => import('@/views/typhoon/4.seawater/index'),
          meta: {
            name: '海流预测'
          }
        }
      ...
      children: [
        {
          path: '/satellite',
          name: 'satellite',
          component: () => import('@/views/typhoon/5.satellite/index'),
          meta: {
            name: '卫星云图'
          }
        }
